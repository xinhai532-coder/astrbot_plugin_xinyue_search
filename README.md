...
- **API基础URL**：心悦搜索API地址，默认 `https://youdomain.com`
...
插件使用以下API端点进行资源搜索：
- 普通搜索: `https://youdomain.com/api/other/web_search`
- 全网搜索: `https://youdomain.com/api/other/all_search`
- 转存分享: `https://youdomain.com/api/open/transfer`
- 获取Cookie: `https://youdomain.com/api/GetCookie/{pan_type}`
